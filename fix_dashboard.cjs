...
// Ensure we get the start of the <div className="space-y-6 pt-2"> or whatever
// Wait, the activeTab === 'dashboard' is wrapping it.
...
code = code.substring(0, startIndex) + newDashboard + "\n        " + code.substring(endIndex);
